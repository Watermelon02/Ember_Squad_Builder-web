              ...
              <Dialog open={openDialogIndex === index}
                ...
                <DialogTrigger asChild>
                  ...
                  >
                    {drone.backpack ? (
                      <img
                        src={`${imgsrc}/${drone.backpack.id}.webp`}
                ...
                <DialogContent className="max-w-5xl w-[90vw]" >
                  ...
                  <div style={{ maxHeight: '70vh', width: '80vw', overflowY: 'auto', paddingRight: '8px', display: 'grid', gridTemplateColumns: 'repeat(2, 1fr)', gap: '12px' }}>
                    {unBackpack.map((bp: any) => (
                      ...
                      >
                        <img src={`${imgsrc}/${bp.id}.webp`} alt={bp.name} style={{ width: '32vw', height: 'auto', objectFit: 'contain', borderRadius: '8px', boxShadow: '0 2px 6px rgba(0,0,0,0.2)' }} draggable={false} />
